...
btnMenu.addEventListener("click", () => {
  // ajouter la classe active ou la retirer
  ligne.classList.toggle("active");
  nav.classList.toggle("menu-visible");
});

// au click ferme le menu
...
let typewriter = new Typewriter(txtAnim, {
  loop: false, //animation 1 seule fois pour eviter que sa tourne a l infini
  deleteSpeed: 20, //vitesse d ecriture pour efface les lettre
});

typewriter
  .pauseFor(1800)
  .changeDelay(20)
  .typeString("Moi c'est Mohamed Ndoye, Développeur ")
  .pauseFor(300)
  ...
  .pauseFor(1000)
  .deleteChars(5)
  .typeString("<strong>en recherche d'alternance</strong> !")
